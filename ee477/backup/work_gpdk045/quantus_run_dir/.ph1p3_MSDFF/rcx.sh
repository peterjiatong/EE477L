...
# This script was generated Sat Nov  9 18:15:56 2024 by:
#
...
flattenLayers -m cont_0pdiff cont_0poly ntap
flattenLayers -m cont_0ndiff cont_0pdiff_metal1_0conn_pdiff_0conn
...
rex -V -m -pd -I'#' -tech \
	...
	- rVia1,2,3,t rVia2,3,4,t rcont_0ndiff_metal1_0conn_ndiff_0conn,2,t \
...
sip -V -s -cgnd ${CAP_GROUND} -sub 2 -L3A -h -R metal5_conn -b \
	metal2_conn,metal1_conn,poly_conn,Oxide,FOX -t \
	metal6_conn,metal7_conn,metal8_conn,metal9_conn,metal10_conn,metal11_conn \
	-Maxw 1.41 -p metal3_conn:metal3_conn_cut,key,metal5_conn,key \
	0,1.57,0 - metal3_conn_metal5_conn.sip
sip -V -s -cgnd ${CAP_GROUND} -sub 2 -h -b \
	metal2_conn,metal1_conn,poly_conn,Oxide,FOX -t \
	metal5_conn,metal6_conn,metal7_conn,metal8_conn,metal9_conn,metal10_conn,metal11_conn \
	-Maxw 1.41 -p metal3_conn:metal3_conn_cut,key,metal4_conn,key \
...
sip -V -s -cgnd ${CAP_GROUND} -sub 2 -L3A -h -R metal4_conn -b \
	...
	metal2_conn:metal2_conn_cut,key,metal4_conn,key 0,0.94,0 - \
