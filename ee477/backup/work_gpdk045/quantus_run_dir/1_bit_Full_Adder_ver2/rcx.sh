...
# This script was generated Wed Oct 16 07:28:56 2024 by:
#
...
#	-newlvs \
#	/home/viterbi/01/tongjia/work_gpdk045/LVS/svdb/1_bit_Full_Adder_ver2.lvsfile \
#	-rcxdir \
#	/home/viterbi/01/tongjia/work_gpdk045/quantus_run_dir/1_bit_Full_Adder_ver2 \
#	-xy_coordinates c,r -type full -temperature 25.0 -tempdir \
#	/home/viterbi/01/tongjia/work_gpdk045/quantus_run_dir/1_bit_Full_Adder_ver2/rcx_temp \
...
#	-output \
#	/home/viterbi/01/tongjia/work_gpdk045/quantus_run_dir/1_bit_Full_Adder_ver2/extview.tmp \
...
#	-hierarchy_delimiter / -hcci_run_name 1_bit_Full_Adder_ver2 \
#	-hcci_run_dir /home/viterbi/01/tongjia/work_gpdk045/LVS/svdb \
#	-hcci_net_prop 5 -hcci_inst_prop 6 -hcci_dev_prop 7 \
#	-ground_substrate_floating_nets true -fracture_length_units MICRONS \
...
#	-agds_layer_map_file \
#	/home/viterbi/01/tongjia/work_gpdk045/LVS/svdb/1_bit_Full_Adder_ver2.gds.map
set -e
set -v
##=======================================================
##ADD_EXPLICIT_VIAS=N
##ADD_BULK_TERMINAL=N
##AGDS_FILE=/dev/null
##AGDS_LAYER_MAP_FILE=/home/viterbi/01/tongjia/work_gpdk045/LVS/svdb/1_bit_Full_Adder_ver2.gds.map
...
##GROUND_SUBSTRATE_FLOATING_NETS=Y
##HCCI_DEV_PROP=7
##HCCI_INST_PROP=6
##HCCI_NET_PROP=5
##HCCI_RULE_FILE=
##HCCI_RUN_DIR=/home/viterbi/01/tongjia/work_gpdk045/LVS/svdb
##HCCI_RUN_NAME=1_bit_Full_Adder_ver2
...
##NETS_FILE=/dev/null
##NP=1
##OUTPUT=/home/viterbi/01/tongjia/work_gpdk045/quantus_run_dir/1_bit_Full_Adder_ver2/extview.tmp
...
##RC_FREQUENCY=
##RCXDIR=/home/viterbi/01/tongjia/work_gpdk045/quantus_run_dir/1_bit_Full_Adder_ver2
##RCXFS_HIGH=N
##RCXFS_NETS_FILE=
##RCXFS_TYPE=none
...
##TEMPDIR=/home/viterbi/01/tongjia/work_gpdk045/quantus_run_dir/1_bit_Full_Adder_ver2/rcx_temp
##TEMPERATURE=25.0
##TYPE=full
...
##VIA_EFFECT_OFF=N
##VIRTUAL_FILL=
##XREF=/home/viterbi/01/tongjia/work_gpdk045/quantus_run_dir/1_bit_Full_Adder_ver2/1_bit_Full_Adder_ver2.gnx,/home/viterbi/01/tongjia/work_gpdk045/quantus_run_dir/1_bit_Full_Adder_ver2/1_bit_Full_Adder_ver2.gdx
##XY_COORDINATES=c,r
##=======================================================
...
setTempDir /home/viterbi/01/tongjia/work_gpdk045/quantus_run_dir/1_bit_Full_Adder_ver2/rcx_temp
DEVICE_FINGER_DELIMITER='@'
HIERARCHY_DELIMITER='/'
OUTPUT_HIERARCHY_DELIMITER='/'
cd /home/viterbi/01/tongjia/work_gpdk045/quantus_run_dir/1_bit_Full_Adder_ver2
...
agds2rcx -V -H satfile -r \
	/home/viterbi/01/tongjia/work_gpdk045/quantus_run_dir/1_bit_Full_Adder_ver2/1_bit_Full_Adder_ver2.xcn \
	...
	-pl 1_bit_Full_Adder_ver2.ports -f 1_bit_Full_Adder_ver2.alm -lnn \
	1_bit_Full_Adder_ver2.lnn -pnet 5 -pinst 6 -pdev 7 \
	1_bit_Full_Adder_ver2.agf 1_bit_Full_Adder_ver2_pin_xy.spi
...
flattenLayers -m cont_0pdiff Via1 ptap
flattenLayers -m cont_0ndiff cont_0poly ntap
flattenLayers -m Via3 cont_0pdiff_metal1_0conn_pdiff_0conn
flattenLayers -m Via2 cont_0ndiff_metal1_0conn_ndiff_0conn
...
connect -V -relocate NET np_rndiff_0conn:np_rndiff_0conn.conn \
	...
	np_rpsubstrate:np_rpsubstrate.conn rVia1 rVia2 rVia3 rcont_0poly \
...
rex -V -m -pd -I'#' -tech \
	...
	-er \
	np_rmetal4_0conn,metal4_conn.den:np_rmetal3_0conn,metal3_conn.den:np_rmetal2_0conn,metal2_conn.den:np_rmetal1_0conn,metal1_conn.den \
	...
	- rVia1,2,3,t rVia2,3,4,t rVia3,4,5,t \
...
epick -f floatlvsnetsfile -c -D ${CAP_GROUND} FOX FOX
geom _0nmos1v,_0pmos1v - qrcgate,1,i,1
...
pax16 -V -lee_off -gnd ${CAP_GROUND} -ignore_cf_table -scf sip.cmd -rcxlvs \
	...
	metal4_conn:metal4_conn_cut metal5_conn metal6_conn metal7_conn \
...
xreduce -V -mergecap -n NET -tech \
	...
	metal11_conn,metal10_conn,metal9_conn,metal8_conn,metal7_conn,metal6_conn,metal5_conn,metal4_conn,metal3_conn,metal2_conn,metal1_conn,poly_conn,Oxide,FOX,np_rndiff_0conn,np_rpdiff_0conn,np_rnwell_0conn,np_rpsubstrate,rVia1,rVia2,rVia3,rcont_0poly \
	-sr -g ${CAP_GROUND},1.0 -danglingR -minR 0.001 -rPvia \
	rVia3.res,rVia2.res,rVia1.res,rcont_0poly.res,rcont_0pdiff_metal1_0conn_pdiff_0conn.res,rcont_0ndiff_metal1_0conn_ndiff_0conn.res \
	-rP \
	np_rpoly_0conn.res,np_rmetal1_0conn.res,np_rmetal2_0conn.res,np_rmetal3_0conn.res,np_rmetal4_0conn.res,mwires.res \
...
advgen -V -g0 -li -f -n -o HSPICE -TL L1T0,L2T0,L3T0 -dxref \
	/home/viterbi/01/tongjia/work_gpdk045/quantus_run_dir/1_bit_Full_Adder_ver2/1_bit_Full_Adder_ver2.gdx \
	-nxref \
	/home/viterbi/01/tongjia/work_gpdk045/quantus_run_dir/1_bit_Full_Adder_ver2/1_bit_Full_Adder_ver2.gnx \
	...
	-rPmw res.mod np_rmetal4_0conn.res,Rnp_rmetal4_0conn.dev2 \
	...
	np_rpoly_0conn.res,Rnp_rpoly_0conn.dev2 rVia3.res,RrVia3.dev2 \
...
ENDCAT
cat \
	/home/viterbi/01/tongjia/work_gpdk045/quantus_run_dir/1_bit_Full_Adder_ver2/hccisavefile \
	>> _save_layers
