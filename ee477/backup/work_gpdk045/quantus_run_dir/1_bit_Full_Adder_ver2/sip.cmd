sip -V -cgnd 6 -s -o -sub 2 -mlc metal3_conn,metal4_conn -er \
...
sip -V -cgnd 6 -s -o -sub 2 -mlc metal4_conn,metal5_conn -er \
...
sip -V -cgnd 6 -s -o -sub 2 -mlc metal5_conn,metal6_conn -er \
...
sip -V -cgnd 6 -s -o -sub 2 -mlc metal6_conn,metal7_conn -er \
...
sip -V -cgnd 6 -s -o -sub 2 -mlc metal7_conn,metal8_conn -er \
...
sip -V -cgnd 6 -s -o -sub 2 -mlc metal8_conn,metal9_conn -er \
	...
	metal10_conn.sip
sip -V -cgnd 6 -s -o -sub 2 -mlc metal9_conn,metal10_conn -n 23.4 \
	-i 0,23.401 -b \
...
sip -V -cgnd 6 -s -o -sub 2 -cp poly_conn,allGate,Oxide -n 1.35 \
...
sip -V -cgnd 6 -s -o -sub 2 -mlc poly_conn -er metal1_conn.den -n \
...
sip -V -cgnd 6 -s -o -sub 2 -mlc poly_conn,metal1_conn -er \
...
sip -V -cgnd 6 -s -o -sub 2 -mlc metal1_conn,metal2_conn -er \
...
sip -V -cgnd 6 -s -o -sub 2 -mlc metal2_conn,metal3_conn -er \
...
sip -V -s -cgnd 6 -sub 2 -L3A -h -R metal9_conn -b \
	metal6_conn,metal5_conn,metal4_conn,metal3_conn,metal2_conn,metal1_conn,poly_conn,Oxide,FOX \
	-t metal10_conn,metal11_conn -Maxw 8.1 -p \
...
sip -V -s -cgnd 6 -sub 2 -L3A -h -R metal8_conn -b \
	metal5_conn,metal4_conn,metal3_conn,metal2_conn,metal1_conn,poly_conn,Oxide,FOX \
	-t metal9_conn,metal10_conn,metal11_conn -Maxw 1.41 -p \
...
sip -V -s -cgnd 6 -sub 2 -L3A -h -R metal7_conn -b \
	metal4_conn,metal3_conn,metal2_conn,metal1_conn,poly_conn,Oxide,FOX \
	-t metal8_conn,metal9_conn,metal10_conn,metal11_conn -Maxw 1.41 -p \
...
sip -V -s -cgnd 6 -sub 2 -L3A -h -R metal6_conn -b \
	metal3_conn,metal2_conn,metal1_conn,poly_conn,Oxide,FOX -t \
...
sip -V -s -cgnd 6 -sub 2 -L3A -h -R metal5_conn -b \
	metal2_conn,metal1_conn,poly_conn,Oxide,FOX -t \
	metal6_conn,metal7_conn,metal8_conn,metal9_conn,metal10_conn,metal11_conn \
...
sip -V -s -cgnd 6 -sub 2 -L3A -h -R metal4_conn -b \
...
sip -V -s -cgnd 6 -sub 2 -h -b metal1_conn,poly_conn,Oxide,FOX -t \
	metal4_conn,metal5_conn,metal6_conn,metal7_conn,metal8_conn,metal9_conn,metal10_conn,metal11_conn \
	-Maxw 1.41 -p \
	metal2_conn:metal2_conn_cut,key,metal3_conn:metal3_conn_cut,key \
	0,0.94,0 - metal2_conn_metal3_conn.sip
sip -V -s -cgnd 6 -sub 2 -L3A -h -R metal3_conn -b \
...
sip -V -s -cgnd 6 -sub 2 -h -b poly_conn,Oxide,FOX -t \
	metal3_conn,metal4_conn,metal5_conn,metal6_conn,metal7_conn,metal8_conn,metal9_conn,metal10_conn,metal11_conn \
	-Maxw 1.41 -p \
	metal1_conn:metal1_conn_cut,key,metal2_conn:metal2_conn_cut,key \
	0,0.94,0 - metal1_conn_metal2_conn.sip
sip -V -s -cgnd 6 -sub 2 -L3A -h -R metal2_conn -b Oxide,FOX -t \
	metal3_conn,metal4_conn,metal5_conn,metal6_conn,metal7_conn,metal8_conn,metal9_conn,metal10_conn,metal11_conn \
...
sip -V -s -cgnd 6 -sub 2 -h -R metal1_conn,poly_conn -b Oxide,FOX \
	-t \
	metal2_conn,metal3_conn,metal4_conn,metal5_conn,metal6_conn,metal7_conn,metal8_conn,metal9_conn,metal10_conn,metal11_conn \
	-Maxw 2.025 -p \
